...
namespace WindowsFormsApp2
{
    public partial class Form1 : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            bindingSource1.DataSource = myOrders.Where
                 (s => { return s.Name == KeyWord2 || s.ID == KeyWord2 || s.Orders == KeyWord2; });
        }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            bindingSource1.DataSource = myOrders.Where
                 (s => { return s.Name == KeyWord4 || s.ID == KeyWord4 || s.Orders == KeyWord4; });
        }
        ...
        private void button4_Click(object sender, EventArgs e)
        {
            ...
            bindingSource1.DataSource = myOrders.Where
                 (s => { return s.Name == KeyWord6 || s.ID == KeyWord6 || s.Orders == KeyWord6; });
        }
    }
}
